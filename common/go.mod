...
require (
	github.com/datacommand2/cdm-center/cluster-manager v0.0.0-20231205061410-2104dd818640
	...
	github.com/datacommand2/cdm-disaster-recovery/manager v0.0.0-20231204060700-d1433b29f7b4
